...
#define DATA_RW_BASE_OFFSET                             0xC0000000
...
#if (VER == 550)
    #define ADDRESS_OSTitle_main_entry_ptr              0x1005E040 // exit to Mii Maker
    #define ADDRESS_main_entry_hook                     0x0101C56C // end of the coreinit_start function
...
#if ( (VER == 532) || (VER == 540) )
    #define ADDRESS_OSTitle_main_entry_ptr              0x1005D180 // located in coreinit.rpl
    #define ADDRESS_main_entry_hook                     0x0101C55C // located in coreinit.rpl (start+15C)
    ...
    #define KERN_SYSCALL_TBL_4                          0xFFEA9CE0 // located in kernel.elf
    #define KERN_SYSCALL_TBL_5                          0xFFEAA0E0 // located in kernel.elf
#elif ( (VER == 500) || (VER == 510) )
    #define ADDRESS_OSTitle_main_entry_ptr              0x1005CB00
    #define ADDRESS_main_entry_hook                     0x0101C15C // start+15C
